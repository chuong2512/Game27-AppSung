namespace nhacdongvat
{
    ...
    public class IAPKeyConstant
    {
        public const string PACK1 = "game27_pack_01";
        public const string PACK2 = "game27_pack_02";
        public const string PACK3 = "game27_pack_03";
        public const string PACK4 = "game27_pack_04";
    }

    public class IAPManagerSingleton : PersistentSingleton<IAPManagerSingleton>, IStoreListener
    {
        private static IStoreController storeController;
        private static IExtensionProvider extensionProvider;
        public static Action OnPurchaseThanhCong;
        ...
        private void InitProduct()
        {
            ...
            builder.AddProduct(IAPKeyConstant.PACK1, ProductType.Consumable);
            builder.AddProduct(IAPKeyConstant.PACK2, ProductType.Consumable);
            builder.AddProduct(IAPKeyConstant.PACK3, ProductType.Consumable);
            builder.AddProduct(IAPKeyConstant.PACK4, ProductType.Consumable);
